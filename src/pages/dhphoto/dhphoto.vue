<template>
  ...
  <!-- <uni-section title="初见(2023.10.14)" type="line">
    <uni-card @click="onClick">
      ...
      <text class="uni-body"
        >与小丁的第一次见面，漫步在秋天的树下，远处的风在动，天边的云在动，站在你旁边的我，心也在动</text
      >
  ...
  <uni-section title="相遇(2023.10.29)" type="line">
    <uni-card @click="onClick">
      ...
      <text class="uni-body"
        >10.08相遇，跟潘潘相处了21天跟最初的热情逗比小瑞瑞相比越来越发现潘潘其实成熟，有自己的想法，洞察力强，很擅长在细节上观察到问题，然后梳理出前因后果，大概因为太聪明，有时候看的很明白，所以才对很多事情敏感，因为有自己的喜恶标准；内心很有力量，大概是有想要保护的人或者想保护自己想要保护的人，总觉得不够好要努力再努力；然后耐心有但不多，有时候你不愿意听的或者不喜欢我的地方你可能不会直接说或者回避了你不知道你能不能意识到，我能意识到的会自己注意，也在等你愿意自然想表达的时候，哪怕我们观点相左都没有关系。</text
      >
